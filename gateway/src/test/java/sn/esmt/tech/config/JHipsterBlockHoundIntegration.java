...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("sn.esmt.tech.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("sn.esmt.tech.security.DomainUserDetailsService", "createSpringSecurityUser");
